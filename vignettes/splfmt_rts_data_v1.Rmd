...
All datasets in the splverse format splfmt_rts_data_v1 will contain these 16 variables.
...
gt::gt(d) %>%
  ...
  gt::tab_header(title = "Unified variables (16) in the splverse format splfmt_rts_data_v1") %>%
  gt::cols_label(
    variable = "Variable",
...
gt::gt(d) %>%
  ...
  gt::tab_header(title = "Task-specific variables in the splverse format splfmt_rts_data_v1") %>%
  gt::cols_label(
    x = "",
    examples = "Examples",
    definition = "Definition"
