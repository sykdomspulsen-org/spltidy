...
d <- rbind(
  ...
  data.frame(
    ...
    definition = "Prediction interval for the baseline (2.5th quantile). 'x' is used to denominate a decimal point, so that we can differentiate between 100 and 10.0."
  ),
  data.frame(
    x = "",
