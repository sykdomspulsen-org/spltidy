...
All datasets in the splverse format splfmt_rts_data_v1_mini will contain these 10 variables.
...
gt::gt(d) %>%
  ...
  gt::tab_header(title = "Unified variables (10) in the splverse format splfmt_rts_data_v1_mini") %>%
  gt::cols_label(
    variable = "Variable",
...
gt::gt(d) %>%
  ...
  gt::tab_header(title = "Task-specific variables in the splverse format splfmt_rts_data_v1_mini") %>%
  gt::cols_label(
    x = "",
    examples = "Examples",
    definition = "Definition"
...
# removing the class splfmt_rts_data_v1_mini (this is uncommon)
d[, .(deaths_n = sum(deaths_n), location_code = "norge"), keyby=.(granularity_time)] %>%
  print()

# Collapsing to different levels, and removing the class splfmt_rts_data_v1_mini because
