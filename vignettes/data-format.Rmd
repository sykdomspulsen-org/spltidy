...
Variable names that are not part of the (unified variables)[#unified-variables] are called context-specific variables, and are made up of 2 mandatory (description, format) and 3 optional (time, statistics, censor/status) sections, separated by underscores.
